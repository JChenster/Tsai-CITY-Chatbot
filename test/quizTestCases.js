...
const invalidAnswerTest = {
    name: 'Edge case of invalid user input to quiz questions',
    steps: genericTest.steps.slice(0, 2).concat([
        [
            'Some invalid answer to the question lmao',
            answerChoicePrompt
        ],
        [
            'Another wrong and invalid answer',
            answerChoicePrompt
        ]
    ]).concat(genericTest.steps.slice(2))
};
